...
PreProc <- function(filename) {
  ...
  #vars <-  str_match(data$timeObs, "(\\d+-\\d+-\\d+) (\\d+)")
  #vars <-  as.data.frame(vars)
  #vars <- vars[, -1]
  #names(vars) <- c("Date", "Time")
  ...
  #data = data %>% 
  #select(Date, Kommune, humidity_past1h, precip_dur_past1h, sun_last1h_glob, temp_mean_past1h, wind_speed_past1h) %>% 
...
sub31 <- sub1
sub31$Kommune <- "Brønderslev"
sub31$Kolonne1 <- "1"

sub32 <- sub1
sub32$Kommune <- "Christiansø"
sub32$Kolonne1 <- "13"
...
sub36 <- sub1
sub36$Kommune <- "Fredensborg"
sub36$Kolonne1 <- "19"

sub37 <- sub1
sub37$Kommune <- "Hillerød"
sub37$Kolonne1 <- "19"

sub38 <- sub1
sub38$Kommune <- "Høje-Taastrup"
sub38$Kolonne1 <- "19"

sub39 <- sub1
sub39$Kommune <- "Odense"
sub39$Kolonne1 <- "12"

sub40 <- sub1
sub40$Kommune <- "Langeland"
sub40$Kolonne1 <- "14"
...
sub42 <- sub1
sub42$Kommune <- "Ringsted"
sub42$Kolonne1 <- "18"

sub43 <- sub1
sub43$Kommune <- "Kerteminde"
sub43$Kolonne1 <- "12"
...
sub47 <- sub1
sub47$Kommune <- "Mariagerfjord"
sub47$Kolonne1 <- "2"

sub48 <- sub1
sub48$Kommune <- "Struer"
sub48$Kolonne1 <- "3"



bind <- rbind(sub, sub1, sub2, sub3, sub4, sub5, sub6, sub7, sub8, sub9, sub10, sub11, sub12, sub13, sub14, sub15, sub16, sub17, sub18, sub19, sub20, sub21, sub22, sub23, sub24, sub25, sub26, sub27, sub28, sub29, sub30, sub31, sub32, sub33, sub34, sub35, sub36, sub37, sub38, sub39, sub40, sub41, sub42, sub43, sub44, sub45, sub46, sub47, sub48)
...
#### Making sure that every region is represented with a day each

```{r Making sure every region has every date}
mobility1$Region <- ifelse(mobility1$Kommune == "Vallensbæk", "Capital Region of Denmark", 
                    ifelse(mobility1$Kommune == "Struer", "Central Denmark Region",
                    ifelse(mobility1$Kommune == "Stevns", "Region Zealand",
                    ifelse(mobility1$Kommune == "Solrød", "Region Zealand",
                    ifelse(mobility1$Kommune == "Odder", "Central Denmark Region",
                    ifelse(mobility1$Kommune == "Morsø", "North Denmark Region",
                    ifelse(mobility1$Kommune == "Lemvig", "Central Denmark Region",
                    ifelse(mobility1$Kommune == "Lejre", "Region Zealand",
                    ifelse(mobility1$Kommune == "Langeland", "Region of Southern Denmark",
                    ifelse(mobility1$Kommune == "Dragør", "Capital Region of Denmark",
                    ifelse(mobility1$Kommune == "Allerød","Capital Region of Denmark",
                    
                    ifelse(mobility1$Kommune == "Kerteminde", "Region of Southern Denmark",
                    ifelse(mobility1$Kommune == "Sorø", "Region Zealand",
                    ifelse(mobility1$Kommune == "Ishøj","Capital Region of Denmark",
                    ifelse(mobility1$Kommune == "Hørsholm", "Capital Region of Denmark",
                    ifelse(mobility1$Kommune == "Herlev", "Capital Region of Denmark",
                    ifelse(mobility1$Kommune == "Glostrup","Capital Region of Denmark", 
                    ifelse(mobility1$Kommune == "Billund", "Region of Southern Denmark",
                   
                    ifelse(mobility1$Kommune == "Nordfyns", "Region of Southern Denmark",
                    ifelse(mobility1$Kommune == "Vejle", "Region of Southern Denmark", 
                    ifelse(mobility1$Kommune == "Vejen", "Region of Southern Denmark",
                    ifelse(mobility1$Kommune == "Varde", "Region of Southern Denmark",       
                    ifelse(mobility1$Kommune == "Tønder", "Region of Southern Denmark",
                    ifelse(mobility1$Kommune == "Svendborg", "Region of Southern Denmark",
                     ifelse(mobility1$Kommune == "Sønderborg", "Region of Southern Denmark",
                     ifelse(mobility1$Kommune == "Nyborg", "Region of Southern Denmark", mobility1$Region))))))))))))))))))))))))))
                      
                   
                            
mobility1$Region <-   ifelse(mobility1$Kommune == "Albertslund","Capital Region of Denmark",
                     ifelse(mobility1$Kommune == "Norddjurs", "Central Denmark Region",
                     ifelse(mobility1$Kommune == "Odsherred", "Region of Southern Denmark",
                     ifelse(mobility1$Kommune == "Randers", "Central Denmark Region",
                    ifelse(mobility1$Kommune == "Skanderborg", "Central Denmark Region",
                    ifelse(mobility1$Kommune == "Silkeborg", "Central Denmark Region",
                     ifelse(mobility1$Kommune == "Skive", "Central Denmark Region",        
                     ifelse(mobility1$Kommune == "Viborg", "Central Denmark Region", 
                    ifelse(mobility1$Kommune == "Horsens", "Central Denmark Region", 
                     ifelse(mobility1$Kommune == "Frederiksberg", "Capital Region of Denmark",
                                    
                     ifelse(mobility1$Kommune == "Kolding", "Region of Southern Denmark",
                     ifelse(mobility1$Kommune == "Esbjerg", "Region of Southern Denmark",
                    ifelse(mobility1$Kommune == "Middelfart", "Region of Southern Denmark",
                    ifelse(mobility1$Kommune == "Vesthimmerlands", "North Denmark Region",        
                    ifelse(mobility1$Kommune == "Thisted", "North Denmark Region",
                    ifelse(mobility1$Kommune == "Rebild", "North Denmark Region", 
                    ifelse(mobility1$Kommune == "Mariagerfjord", "North Denmark Region", 
                    ifelse(mobility1$Kommune == "Holstebro", "North Denmark Region", 
                    ifelse(mobility1$Kommune == "Hjørring", "North Denmark Region",
                           
                     ifelse(mobility1$Kommune == "Roskilde", "Region Zealand",
                     ifelse(mobility1$Kommune == "Ringsted", "Region Zealand",
                    ifelse(mobility1$Kommune == "Rødovre", "Capital Region of Denmark",
                    ifelse(mobility1$Kommune == "Rudersdal", "Capital Region of Denmark",      
                    ifelse(mobility1$Kommune == "Vordingborg", "Region Zealand",
                    ifelse(mobility1$Kommune == "Kalundborg", "Region Zealand", 
                    ifelse(mobility1$Kommune == "Køge", "Region Zealand", 
                    ifelse(mobility1$Kommune == "Lolland", "Region Zealand", 
                    ifelse(mobility1$Kommune == "Holbæk", "Region Zealand",
                    ifelse(mobility1$Kommune == "Hvidovre", "Capital Region of Denmark",
                    ifelse(mobility1$Kommune == "Ringkøbing-Skjern", "Central Denmark Region", 
                    ifelse(mobility1$Kommune == "Næstved", "Region Zealand", 
                    ifelse(mobility1$Kommune == "Hillerød", "Capital Region of Denmark",  
                    ifelse(mobility1$Kommune == "Helsingør", "Capital Region of Denmark",  
                    ifelse(mobility1$Kommune == "Guldborgsund", "Region Zealand",
                    ifelse(mobility1$Kommune == "Gribskov", "Capital Region of Denmark",
                           mobility1$Region)))))))))))))))))))))))))))))))))))


mobility1$Region <-   ifelse(mobility1$Kommune == "Bornholm","Capital Region of Denmark",
                     ifelse(mobility1$Kommune == "Brøndby", "Capital Region of Denmark",
                     ifelse(mobility1$Kommune == "Egedal", "Capital Region of Denmark",
                     ifelse(mobility1$Kommune == "Halsnæs", "Capital Region of Denmark",
                    ifelse(mobility1$Kommune == "Jammerbugt", "North Denmark Region",
                    ifelse(mobility1$Kommune == "Aabenraa", "Region of Southern Denmark",
                     ifelse(mobility1$Kommune == "Assens", "Region of Southern Denmark",        
                     ifelse(mobility1$Kommune == "Ballerup", "Capital Region of Denmark",
                    ifelse(mobility1$Kommune == "Brønderslev", "North Denmark Region",     
                     ifelse(mobility1$Kommune == "Faaborg-Midtfyn	", "Region of Southern Denmark",
                                    
                     ifelse(mobility1$Kommune == "Favrskov", "Central Denmark Region", 
                     ifelse(mobility1$Kommune == "Faxe",  "Region Zealand",
                    ifelse(mobility1$Kommune == "Fredericia", "Region of Southern Denmark",
                    ifelse(mobility1$Kommune == "Fredensborg", "Capital Region of Denmark",      
                    ifelse(mobility1$Kommune == "Frederikssund", "Capital Region of Denmark",
                    ifelse(mobility1$Kommune == "Furesø", "Capital Region of Denmark", 
                    ifelse(mobility1$Kommune == "Gentofte", "Capital Region of Denmark", 
                    ifelse(mobility1$Kommune == "Gladsaxe", "Capital Region of Denmark",
                    ifelse(mobility1$Kommune == "Greve", "Region Zealand",
                            
                     ifelse(mobility1$Kommune == "Haderslev", "Region of Southern Denmark",
                     ifelse(mobility1$Kommune == "Hedensted", "Central Denmark Region", 
                    ifelse(mobility1$Kommune == "Herning",  "Central Denmark Region", 
                    ifelse(mobility1$Kommune == "Høje-Taastrup", "Capital Region of Denmark",      
                    ifelse(mobility1$Kommune == "Ikast-Brande",  "Central Denmark Region", 
                    ifelse(mobility1$Kommune == "Slagelse", "Region Zealand", 
                    ifelse(mobility1$Kommune == "Lyngby-Taarbæk", "Capital Region of Denmark", 
                    ifelse(mobility1$Kommune == "Syddjurs", "Central Denmark Region", 
                    ifelse(mobility1$Kommune == "Frederikshavn", "North Denmark Region", 
                    ifelse(mobility1$Kommune == "Hvidovre", "Capital Region of Denmark",  
                    ifelse(mobility1$Kommune == "Faaborg-Midtfyn","Region of Southern Denmark",       
                           mobility1$Region))))))))))))))))))))))))))))))
...
#kommune$Kommune <- ifelse(kommune$Kommune == "Christiansø", "Christianso", as.character(kommune$Kommune))

#kommune <- subset(kommune, Kommune != "Christianso")
...
#Herkomst3$Herkomst <- Herkomst3$`Indvandrere fra vestlige lande`+Herkomst3$`Indvandrere fra ikke-vestlige lande`+Herkomst3$`Efterkommere fra vestlige lande`+Herkomst3$`Efterkommere fra ikke-vestlige lande`
...
#d7 <- full_join(d7, restrictions, by = "Date")
